...
| 3     | Week 03 | Requirement Analysis             | 18/08/2025 – 23/08/2025 |
| 4     | Week 04 | System Architecture Design       | 28/08/2025 – 02/09/2025 |
| 5     | Week 05 | Implementation Phase – I         | 03/09/2025 – 13/09/2025 |
| 6     | Week 06 | Design & Implementation          | 15/09/2025 – 20/09/2025 |
| 7     | Week 07 | Implementation Phase – II        | 22/09/2025 – 04/10/2025 |
| 8     | Week 08 | Implementation Phase – III       | 06/10/2025 – 18/10/2025 |
...
- Initial problem brainstorming was done.

**Guide Interaction:**  
Guide explained project expectations and documentation process.
...
- Multiple ideas were evaluated.
- Finalized project: *Rental Room Finder for College Students*.

**Guide Interaction:**  
Guide suggested ensuring direct interaction between students and owners.
...
- Functional and non-functional requirements were collected.
- Existing systems were studied.

**Guide Interaction:**  
Guide suggested that to collect more IEEE based research papers.
...
- DFD and ER diagrams were prepared.
- Database structure was planned.

**Guide Interaction:**  
Guide reviewed diagrams and suggested normalization.
...
- Technology stack finalized (Flask, MySQL, HTML, CSS).
- Initial frontend and backend planning started.
...
- Home, login, and registration pages designed.
- Flask project structure created.

**Guide Interaction:**  
Guide suggested improving UI simplicity and validating user input and avoiding duplicate registrations.

**Next Plan:**  
Role-based access and room listing.
...
- Owners can add room details (BHK, occupancy).

**Guide Interaction:**  
Guide suggested **direct student-owner communication**.
...
- Direct communication feature implemented.
- Dashboard improvements done.

**Guide Interaction:**  
Guide suggested adding **question-based feedback with 1–5 star rating**.
...
- Bugs fixed and validation checked.

**Guide Interaction:**  
Guide suggested verifying feedback calculations.
...
**Guide Interaction:**  
Guide suggested documenting limitations.
...
**Team Members:**  
- Member 1: [Kunal Sudhakar Patil]  
- Member 2: [Utkarsh Vishnu Narkhede]  
- Member 3: [Gunjan Pravin Bhamare]  
- Member 4: [Vrushali Machhindra Wadile]  

**Guide:** [Prof.Dr.Ujwala M.Patil]
